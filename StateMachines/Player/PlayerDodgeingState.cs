...
public class PlayerDodgeingState : PlayerBaseState
{
    ...
    public PlayerDodgeingState(PlayerStateMachine stateMachine, Vector3 dodgingDirectionInput) : base(stateMachine)
    {
